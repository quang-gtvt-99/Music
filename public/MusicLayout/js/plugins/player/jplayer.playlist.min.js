    ...
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function(b) {
            ...
            if (d += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>", b.free) {
             ...
             return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'><span class='que_img'><img width='50' height='50' src='"+b.image+"'></span ><div class='que_data'>" + b.title + (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") + "</div></a>", d += "<div class='action'><span class='que_more'><img src='http://localhost:8000/MusicLayout/images/svg/more.svg'></span><span class='que_close jp-playlist-item-remove'><img src='http://localhost:8000/MusicLayout/images/svg/close.svg'></span></div></div>"+b.option+"</li>";
        ...
        next: function() {
            ...
            console.log(this.original[this.current+1].id);
