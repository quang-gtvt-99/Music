<div class="ms_footer_wrapper">
            <div class="ms_footer_logo">
                <a href="index-2.html"><img src="{{asset('MusicLayout/images/logo.png')}}" alt=""></a>
            </div>
            <div class="ms_footer_inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box">
                            <h1 class="footer_title">Lời nhắn gửi</h1>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box footer_subscribe">
                            <h1 class="footer_title">Đăng kí</h1>
                            <p>Đăng kí và nhận những thông báo mới nhất</p>
                            <form>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box footer_contacts">
                            <h1 class="footer_title">Liên hệ với chúng tôi</h1>
                            <ul class="foo_con_info">
                                ...
                                <li>
                                    ...
                                    <div class="foo_con_data">
                                        ...
                                        <span>03 Cầu giấy</span>
                                    </div>
                                </li>
                            </ul>
                            <div class="foo_sharing">
                                <div class="share_title">Theo dõi:</div>
                                <ul>
            ...
            <div class="col-lg-12">
                <div class="ms_copyright">
                    ...
                    <p>Copyright &copy; 2020 <a href="#">The Miraculous Music Template</a>. All Rights Reserved.</p>
                </div>
            </div>
        </div>